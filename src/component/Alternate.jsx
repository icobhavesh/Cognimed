...
//         <div>
//             <div className="sm:col-span-3 bg-amber-700">
...
//                             <div className={`max-w-xs px-4 py-2 rounded-lg ${msg.sender === 'user1' ? 'bg-gray-200 text-black' : 'bg-blue-500 m-4 text-white'}`}>
//                                 <p>{msg.text}</p>
//                             </div>
//                         </div>
//                     ))}
//                     <div className="absolute bottom-0 flex items-center my-20 gap-4">
//                         <div className="flex items-center relative gap-2">
//                             <input type="text" placeholder="Type a message to send" className="px-72 rounded-full py-2 ml-12" />
//                             <IoSendOutline className="mr-6" />
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
const Leftbar = () => {
    ...
    return (
        <div className="grid sm:grid-cols-12 bg-slate-800 w-full h-screen relative">
            <div className="bg-slate-900 sm:col-span-1 h-auto relative">
                <div className="flex pt-10 flex-col items-center gap-6">
                    ...
                    <div className="absolute bottom-0 sm:mb-20 mx-auto ">
                        <FaToggleOn className="text-white w-10 h-10 mt-2 mx-auto" onClick={() => setToggle(!toggle)} />
                    </div>
                </div>
            </div>
